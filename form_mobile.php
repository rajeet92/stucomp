<div class="container"style="margin-top: -70px">
    <div class="border-decor_bottom"style="background-color: rgba(0, 1, 24,0.88)">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group col-md-6 pull-right">
                                            <input type="submit" value="Send"  class="btn btn-primary" style="border-radius: 2px; font-size: 13px; background: #02cc8b; border: none; box-shadow: none;" />
                                        </div>
...
<!-- <input type="submit" value="Send" />-->
                                    ...
                                    <div id="att1" class="col-sm-12 col-md-12" style="display: none;margin-bottom: 5px">    
                                        <button type="button" style="background: none; border: none" onclick="cancel('d1')"class="pull-right"><u>Cancel</u></button>    
                                        <input type="file" name="file[]" id="f1">
                                        <input type="hidden" id="t1" class="hd">
                                    </div>             
                                    <div id="att2" class="col-sm-12 col-md-12" style="display: none;margin-bottom: 5px">
                                        <button type="button" style="background: none; border: none" onclick="cancel('d2')"class="pull-right"><u>Cancel</u></button>
                                        <input type="file" name="file[]" id="f2">
                                        <input type="hidden" id="t2" class="hd">
                                    </div>             
                                    <div id="att3" class="col-sm-12 col-md-12" style="display: none;margin-bottom: 5px">
                                        <button type="button" style="background: none; border: none" onclick="cancel('d3')"class="pull-right"><u>Cancel</u></button> 
                                        <input type="file" name="file[]" id="f3">
                                        <input type="hidden" id="t3" class="hd">
                                    </div>             
                                    <div id="att4" class="col-sm-12 col-md-12" style="display: none;margin-bottom: 5px">
                                        <button type="button" style="background: none; border: none" onclick="cancel('d4')" class="pull-right"><u>Cancel</u></button>  
                                        <input type="file" name="file[]" id="f4"> 
                                        <input type="hidden" id="t4" class="hd">
                                    </div>             
                                    <div id="att5" class="col-sm-12 col-md-12" style="display: none">
                                        <button type="button" style="background: none; border: none" onclick="cancel('d5')" class="pull-right"><u>Cancel</u></button>    
                                        <input type="file" name="file[]" id="f5"> 
